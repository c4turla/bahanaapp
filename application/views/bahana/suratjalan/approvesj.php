...
<div class="page-subheading page-subheading-md">
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="javascript:;">Approve Surat Jalan</a></li>
    </ol>
</div>
<div class="page-heading page-heading-md">
    <h2>Approve Surat Jalan</h2>
</div>
							...
							<?php echo form_open_multipart("suratjalan/simpan",'class="form-horizontal form-bordered Formapprove"'); ?>		
								<fieldset>
                					...
                					<div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                         <input type="text" class="form-control" data-rel="timepicker"  value="<?php echo $NomorSJ; ?>"data-show-meridian="false" data-show-seconds="true" id="time-approve" disabled="disabled">
                                        </div>
									</div>
                                    <div class="form-group">
                                        ...
                                        <div class="controls col-sm-4">
											<div class="input-group">
                            					...
                            					<input type="text" name="uangjalan"  value="<?php echo $uangjalan; ?>" class="form-control" placeholder="0">
                        					</div>
                                        </div>
									</div>
