...
<div class="page-subheading page-subheading-md">
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="javascript:;">Create Client</a></li>
    </ol>
</div>
<div class="page-heading page-heading-md">
    <h2>Create/Edit Client</h2>
</div>
...
<div class="container-fluid-md">
	<div class="panel panel-primary">    	
        ...
        <div class="panel-body">
			<?php echo form_open_multipart("data/TambahClient",'class="form-horizontal form-bordered FormProfile",data-toggle="validator"','data-toggle="validator"'); ?>
			<fieldset>
            ...
            <fieldset>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="" class="form-control" id="nameClient" placeholder="Customer/Agent" name="nameClient" required>
					</div>
				</div>
                <div class="form-group">
