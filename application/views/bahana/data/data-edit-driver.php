...
<div class="container-fluid-md">
	<div class="panel panel-primary">    	
        ...
        <div class="panel-body">
			<?php echo form_open_multipart("data/editsimpandriver",'class="form-horizontal form-bordered FormProfile",data-toggle="validator"','data-toggle="validator"'); ?>
			<fieldset>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="" class="form-control" id="DriverName" placeholder="Driver Name" name="DriverName" value="<?php echo $DriverName ?>">
					</div>
				</div>                
                <div class="form-group">
					...
					<div class="col-sm-4">
						<div class="input-group">
                            ...
                            <input type="text" class="form-control" id="Mobile1" placeholder="Mobile1" name="Mobile1" value="<?php echo $Mobile1 ?>">
						</div>
					</div>
				</div>
                <div class="form-group">
					...
					<div class="col-sm-4">
						<div class="input-group">
                        	<span class="input-group-addon">+62</span>
                            <input type="text" class="form-control" id="Mobile2" placeholder="Mobile2" name="Mobile2" value="<?php echo $Mobile2 ?>">
						</div>
					</div>
				</div>
                <div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" class="form-control" id="PINBB" placeholder="PIN Blackberry" name="PINBB" value="<?php echo $PINBB ?>">
					</div>
				</div>
                <div class="form-group">
                ...
                <div class="form-group">
					...
					<div class="col-sm-4">
                        ...
                        <select class="form-control form-select2" id="Status" data-placeholder="Car Status..." name="Status" >
							...
							<option value="3" <?php if(!empty($Status) && $Status == "3") echo 'selected'; ?>>NOT READY</option>
                        </select>
					</div>
				</div>
			</fieldset>
            ...
            <fieldset>
                ...
                <div class="form-group">
					...
					<div class="col-sm-4">
						<textarea class="form-control autogrow" rows="4" placeholder="Address" id="Address" name="Address"><?php echo $Address ?></textarea>
					</div>
				</div>
                ...
                <div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" class="form-control" id="Province" name="Province" placeholder="Province" value="<?php echo $Province ?>">
					</div>
				</div>
                <div class="form-group">
            ...
            <fieldset>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
                        <img alt="image" class="img-profile"   width="320" id="blah" src="<?php echo base_url(); ?><?php echo 'files/'.$FotoSIM;?>">
                ...
                <div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" class="form-control" id="NoSIM" name="NoSIM" placeholder="SIM Number" value="<?php echo $NoSIM ?>">
					</div>
				</div>
