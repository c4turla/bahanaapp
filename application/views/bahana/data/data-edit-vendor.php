...
<div class="page-subheading page-subheading-md">
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="javascript:;">Edit Vendor</a></li>
    </ol>
</div>
...
<div class="container-fluid-md">
	<div class="panel panel-primary">    	
        <div class="panel-heading">
            <h4 class="panel-title"><strong>Edit Data Vendor</strong></h4>
        ...
        <div class="panel-body">
            ...
            <fieldset>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="" class="form-control" id="nameVendor" placeholder="Customer/Agent" name="nameVendor" value="<?php echo $nameVendor ?>">
					</div>
				</div>
                <div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="" class="form-control" id="email" placeholder="Email" name="email" value="<?php echo $email ?>">
					</div>
				</div>
