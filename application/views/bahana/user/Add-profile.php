        ...
        <div class="panel-body">
                ...
                <div class="form-group">
					...
					<div class="col-sm-5">
						<select class="form-control form-select2" data-placeholder="Group Profiles..." name="Role">
                            ...
                            <option value="2" >Manager Approve</option>
			...
			<fieldset>
                ...
                <div class="form-group">
					...
					<div class="col-sm-5">
						<textarea class="form-control autogrow" rows="4"  name="Address"  placeholder="Address"></textarea>
					</div>
				</div>
			...
			<fieldset>
                ...
                <div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" class="form-control" id="bbm" name="BBMAccount"  placeholder="BBM Accout">
					</div>
				</div>
                <div class="form-group">
					<label for="yahoo" class="col-sm-3 control-label">Yahoo Account</label>
					<div class="col-sm-5">
						<input type="email" class="form-control" id="yahoo" name="YMAccount"  placeholder="Yahoo Account">
					</div>
				</div>
			</fieldset>
            <br />
