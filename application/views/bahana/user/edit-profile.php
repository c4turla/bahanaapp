	...
	<div class="panel panel-primary">
        ...
        <div class="panel-body">
                ...
                <div class="form-group">
					...
					<div class="col-sm-5">
						<select class="form-control form-select2" data-placeholder="Group Profiles..." name="Role">
                            ...
                            <option value="2" <?php if($Role=="2"){echo "selected";}?>>Manager Approve</option>
                            <option value="3" <?php if($Role=="3"){echo "selected";}?>>Reservation</option>
                            <option value="4" <?php if($Role=="4"){echo "selected";}?>>Operational</option>
                            <option value="5" <?php if($Role=="5"){echo "selected";}?>>Finance</option>
                        </select>
					</div>
				</div>
			</fieldset>
			...
			<fieldset>
                ...
                <div class="form-group">
					<label for="bbm" class="col-sm-3 control-label">BBM Account</label>
					<div class="col-sm-5">
						<input type="text" class="form-control" id="bbm" name="BBMAccount" value="<?php echo $BBMAccount; ?>" placeholder="BBM Accout">
					</div>
				</div>
                <div class="form-group">
					<label for="yahoo" class="col-sm-3 control-label">Yahoo Account</label>
					<div class="col-sm-5">
						<input type="email" class="form-control" id="yahoo" name="YMAccount" value="<?php echo $YMAccount; ?>" placeholder="Yahoo Account">
