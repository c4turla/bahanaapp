...
<div class="page-subheading page-subheading-md">
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="javascript:;">Update Faktur</a></li>
    </ol>
</div>
							...
							<?php echo form_open_multipart("faktur/simpan",'class="form-horizontal form-bordered Formapprove"'); ?>		
								<fieldset>
                					...
                					<div class="form-group">
                                        ...
                                        <label class="col-sm-3 control-label" for="time-update">Time Update</label>
                                        <div class="col-sm-2">
                                            <input type="text" class="form-control" data-rel="timepicker"  value="<?php echo $timeupdated; ?>" data-show-meridian="false" data-show-seconds="true" id="time-update" disabled="disabled">
                                        </div>
									</div>
